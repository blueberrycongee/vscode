...
import { RunPlaywrightScriptTool, RunPlaywrightScriptToolData } from './runPlaywrightScriptTool.js';
...
class BrowserChatAgentToolsContribution extends Disposable implements IWorkbenchContribution {
	...
	private _updateToolRegistrations(): void {
		...
		this._toolsStore.add(this.toolsService.registerTool(RunPlaywrightScriptToolData, this.instantiationService.createInstance(RunPlaywrightScriptTool)));
		...
		this._toolsStore.add(browserToolSet.addTool(RunPlaywrightScriptToolData));
